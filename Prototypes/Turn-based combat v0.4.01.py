...
def main():
    ...
    while run_game:
        ...
        for i in range(num_enemies):
            Unit("Enemy " + str(i+1), 1)                                   #fill list with Unit objects
...
class Unit:
    ...
    def __init__(self, name, team):                                   #use 'name' for unit name,
        ...
        self.mp = 10
        self.max_mp = 10
        self.normal_moves_dict = OrderedDict((('Punch',[3,0]),('Kick',[10,0]),('Suck his dick', [-2,0]),('Magic attack',[6,5]), ('Heal',[4,5])))             #ADD YOUR OWN MOVES
